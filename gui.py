...
class Window(QMainWindow):
    ...
    def openAFile(self):
        self.fileName, selectedFilter = QFileDialog.getOpenFileName(self.w, "Select a binary file", "Initial file name", "text file (*.txt)")
        fileIn = open(self.fileName, "r")
        self.inText.setPlainText(fileIn.read())
        self.step2Buttons()

    def saveAFile(self):
        self.fileName, selectedFilter = QFileDialog.getSaveFileName(self.w, "Select a text file", "", "text file (*.txt)")
